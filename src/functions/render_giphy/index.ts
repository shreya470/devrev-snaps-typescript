...
async function updateTimelineEntry(input: any, imageTag: string, imagesMeta: any) {
  ...
  const url = 'https://api.dev.devrev-eng.ai/timeline-entries.update';
  try {
    ...
    const resp = await fetch(url, {
      method: 'POST',
      headers: {
        'authorization': input.input_data.keyrings.devrev_token,
...
async function DeleteTimelineEntry(input: any) {
  ...
  const url = 'https://api.dev.devrev-eng.ai/internal/timeline-entries.delete';
  try {
    const resp = await fetch(url, {
      method: 'POST',
      headers: {
...
async function PostGifToTimeline(input: any, imageTag: string) {
  ...
  const url = 'https://api.dev.devrev-eng.ai/timeline-entries.create';
